...
extension type and the language you chose. The most important one is `@outroll/extensions-sdk`. This package includes a
...
`@outroll/extensions-sdk` to the npm registry. Make sure the name of the package follows the naming convention for
