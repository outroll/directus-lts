...
- **Themes** — See the
  [Light Theme](https://github.com/outroll/directus-lts/blob/main/app/src/styles/themes/_light.scss) or
  [Dark Theme](https://github.com/outroll/directus-lts/blob/main/app/src/styles/themes/_dark.scss)
- **Typography** — See the [Fonts](https://github.com/outroll/directus-lts/blob/main/app/src/styles/_type-styles.scss)
  and [Type Styles](https://github.com/outroll/directus-lts/blob/main/app/src/styles/mixins/type-styles.scss)
- **Variables** — See the
  [Global Variables](https://github.com/outroll/directus-lts/blob/main/app/src/styles/_variables.scss)
