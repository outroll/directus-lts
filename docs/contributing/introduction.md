...
**The Directus [Code of Conduct](https://github.com/outroll/directus-lts/blob/main/code_of_conduct.md) is one of the
...
[Code of Conduct](https://github.com/outroll/directus-lts/blob/main/code_of_conduct.md).**
...
https://github.com/outroll/directus-lts/issues
...
Discussion on our GitHub Discussions board: https://github.com/outroll/directus-lts/discussions
...
[GitHub Discussions](https://github.com/outroll/directus-lts/discussions/categories/q-a) is a great way to help the
project.
...
Each Pull Request that comes in is required to resolve [an open Issue](https://github.com/outroll/directus-lts/issues)
...
[GitHub Security Advisory](https://github.com/outroll/directus-lts/security/advisories) for tracking the fix.
