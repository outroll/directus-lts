...
Go to the [repository](https://github.com/outroll/directus-lts) and fork it to your GitHub account. A fork is your
...
You might want to use the [docker-compose.yml](https://github.com/outroll/directus-lts/blob/main/docker-compose.yml)
...
Check our Wiki for a [guide](https://github.com/outroll/directus-lts/wiki/debugging) on debugging the app and API.
