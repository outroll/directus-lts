...
2. Ensure you’re on the [latest version](https://github.com/outroll/directus-lts/releases/latest) of Directus.
...
8. Check for [existing Issues](https://github.com/outroll/directus-lts/issues?q=is%3Aissue) (and
   [Discussions](https://github.com/outroll/directus-lts/discussions)) that match your problem.
...
[GitHub Discussions](https://github.com/outroll/directus-lts/discussions) is a great first place to reach out for
...
[submit a pull request](https://github.com/outroll/directus-lts/pulls) — after all, it is open-source!
