...
```js
import { Directus } from '@outroll/sdk';
...
```js
import { IAuth, Directus } from '@outroll/sdk';
...
```js
import { BaseStorage, Directus } from '@outroll/sdk';
...
```js
import { ITransport, Directus } from '@outroll/sdk';
...
```js
// import { Directus, ID } from '@outroll/sdk';
const { Directus } = require('@outroll/sdk');
