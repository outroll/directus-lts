import { API_EXTENSION_TYPES, APP_EXTENSION_TYPES, HYBRID_EXTENSION_TYPES } from '@outroll/constants';
import type { ExtensionOptionsBundleEntry } from '@outroll/types';
import { isIn, isTypeIn, pluralize } from '@outroll/utils';
