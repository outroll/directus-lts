## This is a fork of Directus 9.25 that remains under GPLv3 for use cases where a paid license is not feasible. This project is not affiliated with Directus.
